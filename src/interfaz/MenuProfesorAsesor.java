...
public class MenuProfesorAsesor extends javax.swing.JFrame {
  ...
  /**
   * Creates new form MenuProfesorAsesor
   */
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(MenuProfesorAsesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new MenuProfesorAsesor().setVisible(true);
      }
    });
  }
